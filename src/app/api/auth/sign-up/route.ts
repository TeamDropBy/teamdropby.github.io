...
const supabaseUrl =
  ...
  'https://aazjsdrvpiofshwyqjrq.supabase.co';

// IMPORTANT: do NOT throw at the top level.
// Only read env and create the client inside a function.
...
export async function POST(req: Request) {
  try {
    ...
    if (!supabase) {
      // Return a response instead of throwing (prevents build failures)
